...
if (any(unlist(params[paste0(possible_gene_set_methods, '_run')]))){
    ...
    for (gene_set_method in possible_gene_set_methods){
        ...
        if (gene_set_method == 'gsea') {
            ...
            reference_gsea_tables <- paste0(contrasts$id, ".", contrasts$variable, ".", gmt_name, '.gsea_report_for_', contrasts$reference, '.tsv')
            target_gsea_tables <- paste0(contrasts$id, ".", contrasts$variable, ".", gmt_name, '.gsea_report_for_', contrasts$target, '.tsv')
            for (i in 1:nrow(contrasts)){
